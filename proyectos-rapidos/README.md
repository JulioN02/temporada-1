...
Ideas de 1–3 días para resolver un problema, aprender algo o desbloquearte. **No necesitan convertirse en portafolio**: su propósito es practicar y experimentar. Documentación en Obsidian → `Proyectos rápidos/Proyectos Rápidos.md`.

## La regla

No se necesita arquitectura perfecta, frontend espectacular, autenticación, deployment ni documentación enorme. Son **experimentos ejecutables**. Pero cada uno debe responder:
...
Cualquier idea que se te ocurra → al backlog del vault. Si es de 1–3 días y aporta, entra aquí como proyecto rápido.